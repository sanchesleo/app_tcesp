...
import 'package:app_tcesp/repository/informacao_financeira_repository.dart';
import 'package:flutter/material.dart';

import '../icons.dart';

class InformacaoFinanceiraScreen extends StatefulWidget {
  @override
  _InformacaoFinanceiraScreenState createState() =>
      _InformacaoFinanceiraScreenState();
}

class _InformacaoFinanceiraScreenState
    extends State<InformacaoFinanceiraScreen> {
  @override
  ...
  MenuModel licitacoes = new MenuModel(
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          'Informações Financeiras - $municipio',
      ...
      body: Container(
        ...
        child: Container(
          ...
          child: FutureBuilder(
            future: InformacaoFinanceiraRepository()
                .ListAllInformacoesFinanceiras(),
  ...
  ListView buildListView(
      List<InformacoesFinanceirasModel> informacaoFinanceirasModel) {
    return ListView.builder(
      itemCount: informacaoFinanceirasModel.length,
      itemBuilder: (BuildContext context, int index) {
        InformacoesFinanceirasModel listaInformacoes =
  ...
  Container buildCardInformacoes(
      InformacoesFinanceirasModel informacaoFinanceirasModel) {
    return Container(
